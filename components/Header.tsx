...
const Header = () => {
  ...
  return (
    <section
      className={` ${styles.flexBetween} fixed top-0 w-full 2xl:max-w-[1440px] sm:px-7 px-7 z-40 bg-primary-grey-28 dark:bg-secondary-white transition-all duration-300 overflow-hidden ${
