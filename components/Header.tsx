...
const Header = () => {
  ...
  return (
    <section
      className={` ${
        styles.flexBetween
      } fixed top-0 w-full 2xl:max-w-[1440px] px-5 sm:px-7 z-20 bg-primary-grey dark:bg-secondary-white-97 transition-all duration-300 overflow-hidden ${
        ...
        <ul className="flex items-center gap-4 list-none">
          <li>
            <Link
              ...
              className={`${
                pathname === "/" ? "activeLink" : ""
              } transition-all duration-200 text-secondary-white dark:text-primary-grey hover:bg-primary-grey dark:hover:bg-secondary-white-97 p-3 px-8 rounded`}
            >
              Home
            </Link>
          </li>
